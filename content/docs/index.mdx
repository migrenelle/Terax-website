---
title: Welcome
description: Terax is a lightweight terminal-first AI-native dev workspace built on Tauri 2 and React 19.
icon: BookOpen
---
...
1. [Install Terax](/docs/getting-started) and configure your first AI provider.
...
The full keyboard map lives in [Keyboard shortcuts](/docs/reference/shortcuts), and every preference is in [Settings](/docs/reference/settings). For where Terax stores your data on disk, see [Data locations](/docs/reference/data).
