...
description: Tour the Terax window - tabs, sidebar, status bar, and the AI composer.
icon: Layout
---
...
The header carries the tab bar, workspace switcher (Local plus any WSL distro on Windows), and the notification bell. The bell lists every Terax-side and terminal-side agent. See [Notifications](/docs/features/notifications).

## Settings window

`Cmd+,` opens Settings in a separate window. Six tabs: General, Models, Themes, Shortcuts, Agents, About. Every preference Terax persists is here. See [Settings reference](/docs/reference/settings).
