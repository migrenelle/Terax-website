...
<img src="/terminal.webp" alt="Terax terminal with multi-tab and file explorer" width="1200" />
...
See [Shell integration](/docs/reference/shell-integration) for what Terax injects and what escape sequences it watches.
