...
<img src="/ai_workflow.webp" alt="Terax AI agent proposing edit diffs" width="1200" />
...
Type `@` and start the path. Terax fuzzy-matches against the workspace and inserts a chip pointing at the file. The file content is sent at submit, gated by the [secret deny-list](/docs/ai/security#secret-deny-list).
