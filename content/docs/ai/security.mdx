...
API keys live in the OS keychain (service `terax-ai`). The settings file, `localStorage`, and env vars never see a plaintext key. See [Providers and keys](/docs/ai/providers#key-storage).
