...
description: Detect Claude Code in any PTY and route its state into the Terax notification surface.
icon: CommandLine
---
...
- Migrates older Terax-owned hooks from the pre-v2.1.139 `/dev/tty` variant.
